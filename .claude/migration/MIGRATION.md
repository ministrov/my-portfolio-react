...
| ---------------------------- | ----------- | ------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0. Подготовка                | ✅ готов    | —      | 2026-08-05 | Ветка `chore/migrate-vite-react19` от `master` (`feature/redesign-v4` уже влита в 71cfb9b). Метрики CRA сняты. Риски Р1–Р6 перепроверены и подтверждены, добавлен Р7 (JSX в `.js`), уточнён шаг 1.5. Node v24.16.0 ✅ |
