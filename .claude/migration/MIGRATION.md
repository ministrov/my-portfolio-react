...
| 9. Чистка prop-types (опц.)  | ✅ готов | —       | 2026-08-06 | Выполнен отдельной задачей после миграции. 36 файлов, 402 строки удалены; JSDoc дополнен там, где был беднее `propTypes` — см. ниже                                                                                   |
