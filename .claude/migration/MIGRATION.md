...
- из 110 литеральных `t('...')` в коде в локалях отсутствует **один**: `aboutCapabilities.ariaLabel`.

#### Найденный дефект: русский `aria-label` в английской версии
...
**Не чинится в рамках миграции:** дефект предсуществующий, а исправление меняет поведение (английская подпись вместо русской) — это за пределами «поведенческого паритета» раздела 7. **Вынесено в отдельную задачу:** добавить ключ в обе локали и убрать `defaultValue`.
