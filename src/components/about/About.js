          ...
          <div className="about-section__bottom">
            ...
            >
              <p className="about-section__description">
                ...
                specialize in creating functional and beautiful interfaces for
                web applications. My job is to help the customer realize his
                idea and make the product user-friendly.
                <br />
                <br />
                ...
                projects that demonstrate my technical proficiency, design
                skills, and ability to work collaboratively with teams to
