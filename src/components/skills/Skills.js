...
const Skills = () => {
  return (
    <section className="skills">
      <Heading title={"My Skills"} slogan={"Unleash the power of code and create extraordinary digital experiences."} className="skills__title"></Heading>
      ...
      <div className="container">
        <div className="skills__wrapper">
          ...
          <motion.div
            ...
            transition={{ type: 'tween', duration: 1 }}
          >
            <h4 className="skills__slogan">What <span>I can do</span></h4>
