...
export const DEFAULT_CONFIG = {
  /* Потолок числа звёзд. Фон закреплён (position: fixed) и потому анимируется
     всю сессию: каждая звезда — бесконечная анимация плюс will-change, то есть
     отдельный слой композитора. На 350 это налог на всё время чтения страницы,
     включая момент заполнения формы; на глаз плотность поля почти не меняется */
  MAX_STARS: 140,
  MIN_STARS: 50,
  STAR_SIZE_MIN: 0.7,
  STAR_SIZE_MAX: 4,
